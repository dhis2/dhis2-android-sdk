...
User-oriented documentation can be found in [Documentation section](https://www.dhis2.org/documentation) in DHIS2 web. It is intended to be used by developers.
