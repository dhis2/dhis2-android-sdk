...
public class CategoryChangeOnServerShould extends AbsStoreTestCase {
    ...
    public void create_category_in_database_if_audit_type_is_create() throws Exception {
        ...
        assertThat(categoryStore.queryAll().get(0).uid(), is(metadataAudit.getValue().uid()));
    }
    ...
    public void update_category_if_audit_type_is_update() throws Exception {
        ...
        assertThat(categoryStore.queryAll().get(0), is(parseTrackedEntities(
    ...
    private Payload<Category> parseTrackedEntities(String fileName) throws IOException {
