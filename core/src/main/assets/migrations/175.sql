...
INSERT INTO ForeignKeyViolation(fromTable, fromColumn, toTable, toColumn, notFoundValue, fromObjectUid, fromObjectRow, created) SELECT fromTable, fromColumn, toTable, toColumn, notFoundValue, fromObjectUid, fromObjectRow, created FROM ForeignKeyViolation_Old;
...
CREATE TABLE TrackerVisualizationDimension(trackerVisualization TEXT NOT NULL, position TEXT NOT NULL, dimension TEXT NOT NULL, dimensionType TEXT, program TEXT, programStage TEXT, items TEXT, filter TEXT, repetition TEXT, PRIMARY KEY(trackerVisualization, dimension), FOREIGN KEY(trackerVisualization) REFERENCES TrackerVisualization(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT INTO TrackerVisualizationDimension(trackerVisualization, position, dimension, dimensionType, program, programStage, items, filter, repetition) SELECT trackerVisualization, position, dimension, dimensionType, program, programStage, items, filter, repetition FROM TrackerVisualizationDimension_Old;
