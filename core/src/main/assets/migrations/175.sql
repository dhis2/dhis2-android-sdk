...
CREATE TABLE Configuration(serverUrl TEXT NOT NULL, PRIMARY KEY(serverUrl));
INSERT OR IGNORE INTO Configuration(serverUrl) SELECT serverUrl FROM Configuration_Old;

ALTER TABLE User RENAME TO User_Old;
CREATE TABLE User(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, birthday TEXT, education TEXT, gender TEXT, jobTitle TEXT, surname TEXT, firstName TEXT, introduction TEXT, employer TEXT, interests TEXT, languages TEXT, email TEXT, phoneNumber TEXT, nationality TEXT, username TEXT, PRIMARY KEY(uid));
...
CREATE TABLE OrganisationUnit(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, path TEXT, openingDate TEXT, closedDate TEXT, level INTEGER, parent TEXT, displayNamePath TEXT, geometryType TEXT, geometryCoordinates TEXT, PRIMARY KEY(uid));
...
CREATE TABLE OptionSet(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, version INTEGER, valueType TEXT, PRIMARY KEY(uid));
...
CREATE TABLE Option(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, optionSet TEXT NOT NULL, sortOrder INTEGER, color TEXT, icon TEXT, PRIMARY KEY(uid), FOREIGN KEY(optionSet) REFERENCES OptionSet(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE TrackedEntityType(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, featureType TEXT, color TEXT, icon TEXT, accessDataWrite INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE ProgramStageSection(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, sortOrder INTEGER, programStage TEXT NOT NULL, desktopRenderType TEXT, mobileRenderType TEXT, description TEXT, displayDescription TEXT, PRIMARY KEY(uid), FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE ProgramRuleVariable(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, useCodeForOptionSet INTEGER, program TEXT NOT NULL, programStage TEXT, dataElement TEXT, trackedEntityAttribute TEXT, programRuleVariableSourceType TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityAttribute) REFERENCES TrackedEntityAttribute(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(dataElement) REFERENCES DataElement(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE ProgramTrackedEntityAttribute(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, mandatory INTEGER, trackedEntityAttribute TEXT NOT NULL, allowFutureDate INTEGER, displayInList INTEGER, program TEXT NOT NULL, sortOrder INTEGER, searchable INTEGER, PRIMARY KEY(uid), FOREIGN KEY(trackedEntityAttribute) REFERENCES TrackedEntityAttribute(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Constant(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, value TEXT, PRIMARY KEY(uid));
...
CREATE TABLE SystemInfo(serverDate TEXT, dateFormat TEXT, version TEXT, contextPath TEXT NOT NULL, systemName TEXT, PRIMARY KEY(contextPath));
...
CREATE TABLE ProgramRule(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, priority INTEGER, condition TEXT, program TEXT NOT NULL, programStage TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Resource(resourceType TEXT NOT NULL, lastSynced TEXT, PRIMARY KEY(resourceType));
...
CREATE TABLE UserRole(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, PRIMARY KEY(uid));
...
CREATE TABLE Category(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, dataDimensionType TEXT, PRIMARY KEY(uid));
...
CREATE TABLE CategoryOption(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, startDate TEXT, endDate TEXT, accessDataWrite INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE CategoryCombo(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, isDefault INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE CategoryOptionCombo(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, categoryCombo TEXT, PRIMARY KEY(uid), FOREIGN KEY(categoryCombo) REFERENCES CategoryCombo(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE DataSet(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, periodType TEXT, categoryCombo TEXT NOT NULL, mobile INTEGER, version INTEGER, expiryDays REAL, timelyDays REAL, notifyCompletingUser INTEGER, openFuturePeriods INTEGER, fieldCombinationRequired INTEGER, validCompleteOnly INTEGER, noValueRequiresComment INTEGER, skipOffline INTEGER, dataElementDecoration INTEGER, renderAsTabs INTEGER, renderHorizontally INTEGER, accessDataWrite INTEGER, workflow TEXT, color TEXT, icon TEXT, header TEXT, subHeader TEXT, customTextAlign TEXT, tabsDirection TEXT, PRIMARY KEY(uid), FOREIGN KEY(categoryCombo) REFERENCES CategoryCombo(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Indicator(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, annualized INTEGER, indicatorType TEXT, numerator TEXT, numeratorDescription TEXT, denominator TEXT, denominatorDescription TEXT, url TEXT, decimals INTEGER, color TEXT, icon TEXT, PRIMARY KEY(uid), FOREIGN KEY(indicatorType) REFERENCES IndicatorType(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Period(periodId TEXT NOT NULL, periodType TEXT, startDate TEXT, endDate TEXT, PRIMARY KEY(periodId));
...
CREATE TABLE Note(noteType TEXT, event TEXT, enrollment TEXT, value TEXT, storedBy TEXT, storedDate TEXT, uid TEXT NOT NULL, syncState TEXT, deleted INTEGER, PRIMARY KEY(uid), FOREIGN KEY(event) REFERENCES Event(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(enrollment) REFERENCES Enrollment(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Legend(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, startValue REAL, endValue REAL, color TEXT, legendSet TEXT, PRIMARY KEY(uid), FOREIGN KEY(legendSet) REFERENCES LegendSet(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE LegendSet(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, symbolizer TEXT, PRIMARY KEY(uid));
...
CREATE TABLE SystemSetting(key TEXT NOT NULL, value TEXT, PRIMARY KEY(key));
...
CREATE TABLE TrackedEntityAttributeReservedValue(ownerObject TEXT NOT NULL, ownerUid TEXT NOT NULL, key TEXT, value TEXT NOT NULL, created TEXT, expiryDate TEXT, organisationUnit TEXT, temporalValidityDate TEXT, pattern TEXT, PRIMARY KEY(ownerObject, ownerUid, value));
...
CREATE TABLE Section(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, description TEXT, sortOrder INTEGER, dataSet TEXT NOT NULL, showRowTotals INTEGER, showColumnTotals INTEGER, disableDataElementAutoGroup INTEGER, pivotMode TEXT, pivotedCategory TEXT, afterSectionText TEXT, beforeSectionText TEXT, PRIMARY KEY(uid), FOREIGN KEY(dataSet) REFERENCES DataSet(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE RelationshipConstraint(relationshipType TEXT NOT NULL, constraintType TEXT NOT NULL, relationshipEntity TEXT, trackedEntityType TEXT, program TEXT, programStage TEXT, trackerDataViewAttributes TEXT, trackerDataViewDataElements TEXT, PRIMARY KEY(relationshipType, constraintType), FOREIGN KEY(trackedEntityType) REFERENCES TrackedEntityType(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE RelationshipItem(relationship TEXT NOT NULL, relationshipItemType TEXT NOT NULL, trackedEntityInstance TEXT, enrollment TEXT, event TEXT, PRIMARY KEY(relationship, relationshipItemType), FOREIGN KEY(relationship) REFERENCES Relationship(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityInstance) REFERENCES TrackedEntityInstance(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(enrollment) REFERENCES Enrollment(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(event) REFERENCES Event(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE OrganisationUnitGroup(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, PRIMARY KEY(uid));
...
CREATE TABLE ProgramStageDataElement(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, displayInReports INTEGER, compulsory INTEGER, allowProvidedElsewhere INTEGER, sortOrder INTEGER, allowFutureDate INTEGER, dataElement TEXT NOT NULL, programStage TEXT NOT NULL, PRIMARY KEY(uid), FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(dataElement) REFERENCES DataElement(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE IndicatorType(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, number INTEGER, factor INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE ForeignKeyViolation (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fromTable TEXT, fromColumn TEXT, toTable TEXT, toColumn TEXT, notFoundValue TEXT, fromObjectUid TEXT, fromObjectRow TEXT, created TEXT);
INSERT OR IGNORE INTO ForeignKeyViolation(_id, fromTable, fromColumn, toTable, toColumn, notFoundValue, fromObjectUid, fromObjectRow, created) SELECT _id, fromTable, fromColumn, toTable, toColumn, notFoundValue, fromObjectUid, fromObjectRow, created FROM ForeignKeyViolation_Old;

ALTER TABLE D2Error RENAME TO D2Error_Old;
CREATE TABLE D2Error (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, resourceType TEXT, uid TEXT, url TEXT, errorComponent TEXT, errorCode TEXT, errorDescription TEXT, httpErrorCode INTEGER, created TEXT);
INSERT OR IGNORE INTO D2Error(_id, url, errorComponent, errorCode, errorDescription, httpErrorCode, created) SELECT _id, url, errorComponent, errorCode, errorDescription, httpErrorCode, created FROM D2Error_Old;

ALTER TABLE Authority RENAME TO Authority_Old;
CREATE TABLE Authority(name TEXT NOT NULL, PRIMARY KEY(name));
...
CREATE TABLE TrackedEntityTypeAttribute(trackedEntityType TEXT NOT NULL, trackedEntityAttribute TEXT NOT NULL, displayInList INTEGER, mandatory INTEGER, searchable INTEGER, sortOrder INTEGER, PRIMARY KEY(trackedEntityType, trackedEntityAttribute), FOREIGN KEY(trackedEntityType) REFERENCES TrackedEntityType(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityAttribute) REFERENCES TrackedEntityAttribute(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE OrganisationUnitLevel(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, level INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE ProgramSection(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, description TEXT, program TEXT, sortOrder INTEGER, formName TEXT, color TEXT, icon TEXT, desktopRenderType TEXT, mobileRenderType TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE TrackedEntityAttribute(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, shortName TEXT, displayShortName TEXT, description TEXT, displayDescription TEXT, pattern TEXT, sortOrderInListNoProgram INTEGER, optionSet TEXT, valueType TEXT, expression TEXT, programScope INTEGER, displayInListNoProgram INTEGER, generated INTEGER, displayOnVisitSchedule INTEGER, orgunitScope INTEGER, uniqueProperty INTEGER, inherit INTEGER, formName TEXT, fieldMask TEXT, color TEXT, icon TEXT, displayFormName TEXT, aggregationType TEXT, confidential INTEGER, PRIMARY KEY(uid), FOREIGN KEY(optionSet) REFERENCES OptionSet(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE RelationshipType(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, fromToName TEXT, toFromName TEXT, bidirectional INTEGER, accessDataWrite INTEGER, PRIMARY KEY(uid));
...
CREATE TABLE TrackedEntityInstance(uid TEXT NOT NULL, created TEXT, lastUpdated TEXT, createdAtClient TEXT, lastUpdatedAtClient TEXT, organisationUnit TEXT, trackedEntityType TEXT, geometryType TEXT, geometryCoordinates TEXT, syncState TEXT, aggregatedSyncState TEXT, deleted INTEGER, PRIMARY KEY(uid), FOREIGN KEY(organisationUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityType) REFERENCES TrackedEntityType(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Enrollment(uid TEXT NOT NULL, created TEXT, lastUpdated TEXT, createdAtClient TEXT, lastUpdatedAtClient TEXT, organisationUnit TEXT NOT NULL, program TEXT NOT NULL, enrollmentDate TEXT, incidentDate TEXT, followup INTEGER, status TEXT, trackedEntityInstance TEXT NOT NULL, syncState TEXT, aggregatedSyncState TEXT, geometryType TEXT, geometryCoordinates TEXT, deleted INTEGER, completedDate TEXT, PRIMARY KEY(uid), FOREIGN KEY(organisationUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityInstance) REFERENCES TrackedEntityInstance(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE Event(uid TEXT NOT NULL, enrollment TEXT, created TEXT, lastUpdated TEXT, createdAtClient TEXT, lastUpdatedAtClient TEXT, status TEXT, geometryType TEXT, geometryCoordinates TEXT, program TEXT NOT NULL, programStage TEXT NOT NULL, organisationUnit TEXT NOT NULL, eventDate TEXT, completedDate TEXT, dueDate TEXT, syncState TEXT, aggregatedSyncState TEXT, attributeOptionCombo TEXT, deleted INTEGER, assignedUser TEXT, completedBy TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(enrollment) REFERENCES Enrollment(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(organisationUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(attributeOptionCombo) REFERENCES CategoryOptionCombo(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE TrackedEntityDataValue(event TEXT NOT NULL, dataElement TEXT NOT NULL, storedBy TEXT, value TEXT, created TEXT, lastUpdated TEXT, providedElsewhere INTEGER, syncState TEXT, PRIMARY KEY(event, dataElement), FOREIGN KEY(event) REFERENCES Event(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(dataElement) REFERENCES DataElement(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE FileResource(uid TEXT NOT NULL, name TEXT, created TEXT, lastUpdated TEXT, contentType TEXT, contentLength INTEGER, path TEXT, syncState TEXT, domain TEXT, PRIMARY KEY(uid));
...
CREATE TABLE AuthenticatedUser(user TEXT NOT NULL, hash TEXT, PRIMARY KEY(user), FOREIGN KEY(user) REFERENCES User(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE GeneralSetting(encryptDB INTEGER NOT NULL, lastUpdated TEXT, reservedValues INTEGER, smsGateway TEXT, smsResultSender TEXT, matomoID INTEGER, matomoURL TEXT, allowScreenCapture INTEGER, messageOfTheDay TEXT, experimentalFeatures TEXT, bypassDHIS2VersionCheck INTEGER, PRIMARY KEY(encryptDB));
...
CREATE TABLE DataSetSetting (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uid TEXT, name TEXT, lastUpdated TEXT, periodDSDownload INTEGER, periodDSDBTrimming INTEGER, FOREIGN KEY (uid) REFERENCES DataSet (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT OR IGNORE INTO DataSetSetting(_id, uid, name, lastUpdated, periodDSDownload, periodDSDBTrimming) SELECT _id, uid, name, lastUpdated, periodDSDownload, periodDSDBTrimming FROM DataSetSetting_Old;

ALTER TABLE ProgramSetting RENAME TO ProgramSetting_Old;
CREATE TABLE ProgramSetting (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uid TEXT, name TEXT, filters TEXT, lastUpdated TEXT, teiDownload INTEGER, teiDBTrimming INTEGER, eventsDownload INTEGER, eventsDBTrimming INTEGER, updateDownload TEXT, updateDBTrimming TEXT, settingDownload TEXT, settingDBTrimming TEXT, enrollmentDownload TEXT, enrollmentDBTrimming TEXT, eventDateDownload TEXT, eventDateDBTrimming TEXT, enrollmentDateDownload TEXT, enrollmentDateDBTrimming TEXT, FOREIGN KEY (uid) REFERENCES Program (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT OR IGNORE INTO ProgramSetting(_id, uid, name, lastUpdated, teiDownload, teiDBTrimming, eventsDownload, eventsDBTrimming, updateDownload, updateDBTrimming, settingDownload, settingDBTrimming, enrollmentDownload, enrollmentDBTrimming, eventDateDownload, eventDateDBTrimming, enrollmentDateDownload, enrollmentDateDBTrimming) SELECT _id, uid, name, lastUpdated, teiDownload, teiDBTrimming, eventsDownload, eventsDBTrimming, updateDownload, updateDBTrimming, settingDownload, settingDBTrimming, enrollmentDownload, enrollmentDBTrimming, eventDateDownload, eventDateDBTrimming, enrollmentDateDownload, enrollmentDateDBTrimming FROM ProgramSetting_Old;

ALTER TABLE SynchronizationSetting RENAME TO SynchronizationSetting_Old;
CREATE TABLE SynchronizationSetting(dataSync TEXT NOT NULL, metadataSync TEXT, trackerImporterVersion TEXT, trackerExporterVersion TEXT, fileMaxLengthBytes INTEGER, PRIMARY KEY(dataSync));
...
INSERT OR IGNORE INTO ProgramConfigurationSetting(_id, uid, completionSpinner, optionalSearch, disableReferrals, disableCollapsibleSections, itemHeaderProgramIndicator, minimumLocationAccuracy, disableManualLocation, quickActions) SELECT _id, uid, completionSpinner, optionalSearch, disableReferrals, disableCollapsibleSections, itemHeaderProgramIndicator, minimumLocationAccuracy, disableManualLocation, quickActions FROM ProgramConfigurationSetting_Old;

ALTER TABLE DataSetConfigurationSetting RENAME TO DataSetConfigurationSetting_Old;
CREATE TABLE DataSetConfigurationSetting (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uid TEXT, minimumLocationAccuracy INTEGER, disableManualLocation INTEGER);
INSERT OR IGNORE INTO DataSetConfigurationSetting(_id, uid, minimumLocationAccuracy, disableManualLocation) SELECT _id, uid, minimumLocationAccuracy, disableManualLocation FROM DataSetConfigurationSetting_Old;

ALTER TABLE CustomIntent RENAME TO CustomIntent_Old;
CREATE TABLE CustomIntent(uid TEXT NOT NULL, name TEXT, action TEXT, packageName TEXT, requestArguments TEXT, responseDataExtras TEXT, PRIMARY KEY(uid));
...
CREATE TABLE CustomIntentDataElement(uid TEXT NOT NULL, customIntentUid TEXT NOT NULL, PRIMARY KEY(customIntentUid, uid), FOREIGN KEY(customIntentUid) REFERENCES CustomIntent(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE CustomIntentAttribute(uid TEXT NOT NULL, customIntentUid TEXT NOT NULL, PRIMARY KEY(customIntentUid, uid), FOREIGN KEY(customIntentUid) REFERENCES CustomIntent(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE AnalyticsTeiSetting(uid TEXT NOT NULL, name TEXT NOT NULL, shortName TEXT NOT NULL, program TEXT NOT NULL, programStage TEXT, period TEXT, type TEXT NOT NULL, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE UserSettings(keyUiLocale TEXT NOT NULL, keyDbLocale TEXT, PRIMARY KEY(keyUiLocale));
...
CREATE TABLE AggregatedDataSync(dataSet TEXT NOT NULL, periodType TEXT NOT NULL, pastPeriods INTEGER NOT NULL, futurePeriods INTEGER NOT NULL, dataElementsHash INTEGER NOT NULL, organisationUnitsHash INTEGER NOT NULL, lastUpdated TEXT NOT NULL, PRIMARY KEY(dataSet), FOREIGN KEY (dataSet) REFERENCES DataSet (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE TrackedEntityInstanceSync (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, program TEXT, organisationUnitIdsHash INTEGER NOT NULL, downloadLimit INTEGER NOT NULL, lastUpdated TEXT NOT NULL, FOREIGN KEY (program) REFERENCES Program (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT OR IGNORE INTO TrackedEntityInstanceSync(_id, program, organisationUnitIdsHash, downloadLimit, lastUpdated) SELECT _id, program, organisationUnitIdsHash, downloadLimit, lastUpdated FROM TrackedEntityInstanceSync_Old;

ALTER TABLE EventSync RENAME TO EventSync_Old;
CREATE TABLE EventSync(_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, program TEXT, organisationUnitIdsHash INTEGER NOT NULL, downloadLimit INTEGER NOT NULL, lastUpdated TEXT NOT NULL, FOREIGN KEY (program) REFERENCES Program (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT OR IGNORE INTO EventSync(_id, program, organisationUnitIdsHash, downloadLimit, lastUpdated) SELECT _id, program, organisationUnitIdsHash, downloadLimit, lastUpdated FROM EventSync_Old;

ALTER TABLE CategoryOptionOrganisationUnitLink RENAME TO CategoryOptionOrganisationUnitLink_Old;
CREATE TABLE CategoryOptionOrganisationUnitLink(_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, categoryOption TEXT NOT NULL, organisationUnit TEXT, restriction TEXT, FOREIGN KEY(categoryOption) REFERENCES CategoryOption(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(organisationUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE TrackedEntityInstanceEventFilter (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, trackedEntityInstanceFilter TEXT NOT NULL, programStage TEXT, eventStatus TEXT, periodFrom INTEGER, periodTo INTEGER, assignedUserMode TEXT, FOREIGN KEY (trackedEntityInstanceFilter) REFERENCES TrackedEntityInstanceFilter (uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
INSERT OR IGNORE INTO TrackedEntityInstanceEventFilter(_id, trackedEntityInstanceFilter, programStage, eventStatus, periodFrom, periodTo, assignedUserMode) SELECT _id, trackedEntityInstanceFilter, programStage, eventStatus, periodFrom, periodTo, assignedUserMode FROM TrackedEntityInstanceEventFilter_Old;

ALTER TABLE EventFilter RENAME TO EventFilter_Old;
CREATE TABLE EventFilter(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, program TEXT NOT NULL, programStage TEXT, description TEXT, followUp INTEGER, organisationUnit TEXT, ouMode TEXT, assignedUserMode TEXT, orderProperty TEXT, displayColumnOrder TEXT, events TEXT, eventStatus TEXT, eventDate TEXT, dueDate TEXT, lastUpdatedDate TEXT, completedDate TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(organisationUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE ReservedValueSetting(uid TEXT NOT NULL, numberOfValuesToReserve INTEGER, PRIMARY KEY(uid), FOREIGN KEY(uid) REFERENCES TrackedEntityAttribute(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE VisualizationDimensionItem(visualization TEXT NOT NULL, position TEXT NOT NULL, dimension TEXT NOT NULL, dimensionItem TEXT NOT NULL, dimensionItemType TEXT, sortOrder INTEGER, PRIMARY KEY(visualization, dimensionItem), FOREIGN KEY(visualization) REFERENCES Visualization(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE LocalDataStore(key TEXT NOT NULL, value TEXT, PRIMARY KEY(key));
...
CREATE TABLE SMSConfig(key TEXT NOT NULL, value TEXT, PRIMARY KEY(key));
...
CREATE TABLE SMSOngoingSubmission(submissionId INTEGER NOT NULL, type TEXT, PRIMARY KEY(submissionId));
...
CREATE TABLE StockUseCase(uid TEXT NOT NULL, itemCode TEXT, itemDescription TEXT, programType TEXT, description TEXT, stockOnHand TEXT, PRIMARY KEY(uid), FOREIGN KEY(uid) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE ProgramStageWorkingList(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, description TEXT, program TEXT NOT NULL, programStage TEXT NOT NULL, eventStatus TEXT, eventCreatedAt TEXT, eventOccurredAt TEXT, eventScheduledAt TEXT, enrollmentStatus TEXT, enrolledAt TEXT, enrollmentOccurredAt TEXT, orderProperty TEXT, displayColumnOrder TEXT, orgUnit TEXT, ouMode TEXT, assignedUserMode TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(orgUnit) REFERENCES OrganisationUnit(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE LatestAppVersion(version TEXT NOT NULL, downloadURL TEXT, PRIMARY KEY(version));
...
CREATE TABLE ExpressionDimensionItem(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, expression TEXT, PRIMARY KEY(uid));
...
CREATE TABLE TrackerVisualization(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, description TEXT, displayDescription TEXT, type TEXT, outputType TEXT, program TEXT, programStage TEXT, trackedEntityType TEXT, sorting TEXT, PRIMARY KEY(uid), FOREIGN KEY(program) REFERENCES Program(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(programStage) REFERENCES ProgramStage(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED, FOREIGN KEY(trackedEntityType) REFERENCES TrackedEntityType(uid) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE CustomIcon(key TEXT NOT NULL, fileResource TEXT NOT NULL, href TEXT NOT NULL, PRIMARY KEY(key));
...
CREATE TABLE UserGroup(uid TEXT NOT NULL, code TEXT, name TEXT, displayName TEXT, created TEXT, lastUpdated TEXT, PRIMARY KEY(uid));
...
CREATE UNIQUE INDEX datasetsettinguid ON DataSetSetting(uid);
CREATE UNIQUE INDEX eventsyncprogram_organisationunithash ON EventSync(program, organisationUnitIdsHash);
CREATE UNIQUE INDEX programsettinguid ON ProgramSetting(uid);
CREATE UNIQUE INDEX teisyncprogram_organisationunithash ON TrackedEntityInstanceSync(program, organisationUnitIdsHash);
