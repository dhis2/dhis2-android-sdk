...
INSERT INTO SystemInfo(serverDate, dateFormat, version, contextPath, systemName) SELECT serverDate, dateFormat, version, contextPath, systemName FROM SystemInfo_Old;
