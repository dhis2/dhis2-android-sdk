...
internal class LegendEvaluator @Inject constructor(
    ...
    fun getLegendByProgramIndicator(programIndicatorUid: String, value: String?): Legend? {
    ...
    fun getLegendByDataElement(dataElementUid: String, value: String?): Legend? {
        return if (value == null) {
            null
        } else try {
    ...
    fun getLegendByIndicator(indicatorUid: String, value: String?): Legend? {
        return if (value == null) {
            null
        } else try {
    ...
    fun getLegendByLegendSet(legendSetUid: String, value: String?): Legend? {
