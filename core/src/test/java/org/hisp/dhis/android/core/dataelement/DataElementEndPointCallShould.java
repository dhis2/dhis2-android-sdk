...
public class DataElementEndPointCallShould {
    ...
    public void throws_illegal_argument_exception_if_uids_size_exceeds_the_limit() {
        givenADataElementEndPointCall(MAX_UIDS + 1);
    }

    @Test
    public void create_relationship_type_call_if_uids_size_does_not_exceeds_the_limit() {
        DataElementEndPointCall relationshipTypeEndPointCall =
                givenADataElementEndPointCall(MAX_UIDS);
    ...
    private DataElementEndPointCall givenADataElementEndPointCall(int uidsSize) {
