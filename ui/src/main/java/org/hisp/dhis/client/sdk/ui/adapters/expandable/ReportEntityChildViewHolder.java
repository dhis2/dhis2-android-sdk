...
public class ReportEntityChildViewHolder<C> extends ChildViewHolder<C> {
    ...
    private class MenuClickHandler implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (reportEntity.getStatus() == ReportEntity.Status.TO_POST ||
                    reportEntity.getStatus() == ReportEntity.Status.TO_UPDATE ||
                    reportEntity.getStatus() == ReportEntity.Status.ERROR) {
